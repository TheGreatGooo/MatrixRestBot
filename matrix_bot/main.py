...
async def main_loop(homeserver, bot_user_id, device_name, bot_password, room_id) -> None:
...
def main() -> None:
    ...
    asyncio.get_event_loop().run_until_complete(main_loop(args.homeserver, args.bot_uid, args.device_name, args.bot_pwd, args.room_id))